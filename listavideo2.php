            ...
            <!-- end: imagPerf -->
                ...
                if(mysqli_num_rows($query)!==0 )
                   ...
                   $VideoMini = $valores['Miniatura'];     
                    ...
                    echo 
                 "<div class=\"videoEnLista\">

                    <img class=\"vidIconLista\" src=\"$VideoMini\">
                    <div class=\"infoVideoLista\">
                        <div class=\"nomListaVid\">
                            <h2>$videoTittle</h2>
                        </div>
                        <br>
                        <br>
                        <div class=\"botonesLista\">
                                ...
                                <div class=\"editarVidLista\">
                                <form action=\"EditarVideo.php\" name=\"editar\" method=\"POST\">
                                 <input type=\"hidden\" name=\"Video\" id=\"Video\" value =\"$VideoId\">
                                    <input type=\"submit\" value=\"Editar\">
                                    </form>
                                </div>
                                <div class=\"borrarVidLista\">
                                <form action=\"Php\BorrarVideo.php\" name=\"editar\" method=\"POST\">
                                <input type=\"hidden\" name=\"Video\" id=\"Video\" value =\"$VideoId\">
